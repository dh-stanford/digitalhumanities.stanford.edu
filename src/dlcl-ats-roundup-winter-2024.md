...
This quarter, I found out that all my ADHO proposals were accepted (SILICON poster, DH RPG mini-conference, DH Makes mini-conference, non-English NLP workshop). The project management class being such a source of inspiration, I'm especially looking forward to revisiting the game at the conference, as well as DH Makes: I continue to dream of a DH fashion show with live music from _The Hard Modes_.
